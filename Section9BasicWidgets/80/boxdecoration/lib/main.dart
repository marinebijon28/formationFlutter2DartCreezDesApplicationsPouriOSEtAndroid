/**
 * Documentation
 * Quand on clique sur n'importe laquelle des éléments. On va voir notre
          ...
          child: Center (
            ...
            */
                ...
                child: Padding(
                   ...
                   * Je vais vouloir dérouler ma colonne. Je vais prendre un
                   * child qui sera SingleChildScrollView et il aura besoin d'un
                   * child uniquement. Donc je vais prendre ma colonne, jusqu'à
                   * ma colonne. Je la coupe, et je la colle ici dans
                   * SingleChildScrollView. Maintenant si je lance et on va
                   * pouvoir dérouler
                   */
                  child : SingleChildScrollView(
                    /**
                     * Ici dans mon SingleChildScrollView qu'est-ce qu'on va
                     * avoir ? Un ScrollDirection si j'avais fait un
                     * Axis.horizontal. On aurait eu un problème parce que c'est
                     * pas le bon axe et le vertical. Ça aurait fonctionner de
                     * base c'est direction vertical. C'est Widgetqui va nous
                     * permettre d'avoir plusieurs éléments déroulant
                     */
                    child: Column(
                      /**
                       * Vous voyez qu'on a notre card qui a prit toute la
                      ...
                      children: [
                        ...
                        Stack(
                          ...
                          children: [
                            ...
                            /**
                             * Ce que je vais faire ici. Je vais prendre mon texte
                             * un autre élément. Il est ici, je vais le mettre
                             * dans une Row avec des childrens.
                             */
                            Row(
                              /**
                               * Alors Matthieu ça imagine qu'on fasse un
                               * mainAxisAlignment.end. Si j'avais pas rajouté le
                               * spacer. Ça aurait donné pareil.
                               */
                              mainAxisAlignment : MainAxisAlignment.end,
                              children: [
                                /**
                                 *  Imaginez que je veuille juste avant une
                                 *  icône Icons.favorite. Je vais rajouter une
                                 *  deuxième icône Icons.height et aue je ne
                                 *  rajoute pas le spacer. Ils sont tous là et
                                 *  que je voulais que ce groupe là soit collé à
                                 *  gauche et que notre élément soit à droite.
                                 */
                                Icon(Icons.favorite),
                                Icon(Icons.height),
                                /**
                                 * Je vais prendre ce texte, Je vais le mettre
                                 * dedans et là il est tout à gauche. C'est pas ce
                                 * que je veux, Je pourrais ajouter spacer. Je
                                 * pourrais ajouter spacer que j'initialise avec
                                 * parenthése vide. Là désormais on est collée à
                                 * droite.
                                 * Là j'utilise le spacer parce qu'il va coller
                                 * les deux éléments. Il va prendre l'espace
                                 * disponible et tout sera comme je le veux.
                                 */
                                Spacer(),
                                Text("Un autre élément"),
                              ],
                          ...
                          /**
                           * Maintenant passons à ce que l'on appelle le spacer.
                           * Alors, qu'est-ce qui est le spacer Matthieu . Ça va
                           * être Widget qui ressemble à Expanded, mais à part
                           * qu'on ne va pas rajouter de child à l'intérieur. Ça
                           * veut dire qu'il va espacer nos éléments. Il va
                           * prendre la taille restante. Par exemple ici, on a un
                           * autre élément. Je voudrais que cet autre élément.
                           * soit collé à droite, mais le truc si je le colle sur
                           * la droite. Si je fais topRight. Tous les éléments
                           * seront collés à droite. C'est pas ce aue je veux.
                           */
                        ...
                        /**
                         * Je vais vouloir décorer un container. Ça veut dire
                         * quoi Matthieu ? Ça veut dire après mon divider. Je
                         * vais vouloir ici un container.
                         */
                        Container(
                          /**
                           * On va rajouter une margin EdgeInsets.all(20). Comme
                           * ça on verra tout bien. Vous voyez qu'on voit notre
                           * couleur. Notre shadow
                           */
                          margin: EdgeInsets.all(20),
                          /**
                           * Ce container je vais vouloir une height disons 200
                           * et une width qui soit ma size.width. Si je relance
                           * On va rien voir parce que je vais voir un container
                           * tout blanc.
                           */
                          height: 200,
                          width: size.width,
                          /**
                           * Je vais voir ce que je vais avoir ce que l'on
                           * appelle une décoration. Dans cette décoration, je
                           * vais pouvoir choisir une BoxShadow, BoxDecoration
                           * et d'autres élements. La BoxDecoration va nous
                           * servir à quoi ? Ça va nous servir par exemple à
                           * avoir une color pas forcément utile étant donnée
                           * qu'on a le midifyer color. 
                           */
                          decoration: BoxDecoration(
                            /**
                             * On pourrait avoir une image qui sera quoi ? Vous
                             * voyez qu'on a une erreur parce qu'il veut une
                             * décoration image et cette décoration image.
                             * Cette decoration image, on peut avoir un fit.
                             * On pourait avoir autre chose. On pourrait avoir
                             * en décoration. On lui a ajouté une image. On
                             * pourrait ajouter en plus de la décoration Image.
                             * On pourrait ajouter un BoxShadow qui sera une
                             * liste de BoxShadow.
                             */
                           // image: Image.asset("images/beach.jpg"),
                            image: DecorationImage(
                              /**
                               * Elle aura elle-même une image qui sera une
                               * imageProvider.
                               */
                              ...
                              /**
                               * Pourquoi ? cette Boxshadows va avoir quoi
                               * ? un offset, un blurRadius, spreadRadius,
                               * BlurStyle.
                               */
                            boxShadow: [
                              BoxShadow(
                                /**
                                 * Donc la je prends BoxShadows On va avoir une
                                 * couleur. Ça nous donne quoi ? Ça nous donne
                                 * rien. SI je veux ajouter une couleur quand il
                                 * y a une décoration je l'ajoute ici
                                 */
                                color: Colors.yellow,
                                /**
                                 * Un offset on va avoir 3, 3. On ne le voit pas
                                 * bien parce que tous les éléments sont collés.
                                 * On va peut être mettre à 2, 2.
                                 */
                                offset: Offset(2, 2),
                                /**
                                 * Si je tape Radius. Si je le mets à 2. Ça va
                                 * atténuer un peu
                                 */
                                blurRadius: 2,
                                /**
                                 * On a le spreadRadius. On le mets sur 5. Si je
                                 * l'avais mis sur 1.
                                 */
                                spreadRadius: 1,
                              )
                              ...
                              /**
                               * On sort de ma liste. On pourrait avoir un
                               * shape qui soit un BoxShape.cirle. on a arrondis
                               * notre boxshape. Comme ça c'est comme notre
                               * avatarCirle.
                               */
                              //shape: BoxShape.circle,
                            /**
                             * On va avoir aussi un radius. On pourrait avoir un
                             * arrondis. Donc un borderRadius aussi gradient. On
                             * pourrait choisir une boxBorder. Là je vais faire
                             * BorderRadiusAll(). Là je vais avoir un
                             * radius.circular de 15. Là vous voyez qu'on a
                             * juste des borders arrondis. Ça donne des trucs
                             * pas mal. Ça donne un petit côté sympathique. on
                             * les verra petit à petit. C'est vraiment les
                             * essentiels pour avoir une ombre, pour avoir un
                             * radius, ajouter une image ronde. P
                             * our ajouter une image en fond. On aurait pus
                             * juste ajouté une couleur.
                             */
                            borderRadius: BorderRadius.all(Radius.circular(
                                15))
                          ),
                          /**
                           * * Ça pourrait nous servir à quoi Matthieu ? Ça
                           * pourrait nous servir, par exemple si on veut un
                           * container ou on a un child avec un Text. on va
                           * juste rajouter Container. On pourra nous continuer
                           * nos éléments c'est pour avoir une décoration de
                           * fond d'un container
                           */
                          child: Text("Container"),
                          /**
                           * Si on a une décoration je ne peux pas ajouter une
                           * couleur. On peut pas ajouter une décoration et une
                           * couleur. Donc si vous voulez une couleur. Il faut
                           * l'ajouter dans la décoration.
                           */
                          //color: Colors.green,
                        ),
                        Container(
                        ...
                        // spanDemo(),
                        /**
                         * Allez je vous montre un autre élément basique le
                         * SingleChildScrowView. Qu'est-ce que le S
                         * ingleChildScrowView ? Il est possible que par exemple
                         * notre application. Je vais aller dans mon fromNetwork
                         * iiciavant le SpanDemo. Je vais aller le copier et le
                         * coller. Aie on a un bottom overflow. Ça veut dire auoi
                         * Matthieu ? Ça veut dire le nombre d'image. Enfin le
                         * nombre d'éléments UI en taille et hauteur sur notre
                         * application et trop grand par rapport à son contenant.
                         * Donc par rapport à la vue du smartphone. Donc on va pas
                         * pouvoir tout montrer. Donc on a une erreur. Pour ceci
                         * on va avoir un élément SingleChildScrollView. Donc un
                         * enfant unique ScrollView une vue déroulante. Ça veut
                         * dire qu'on va pouvoir avoir un élément scrollable qui
                         * va être déroulant et qu'est-ce qu'on va vouloir
                         * dérouler ? On va vouloir dérouler ma colonne.
                         */
                        fromNetwork(size),
                        spanDemo(),
                        fromNetwork(size),
